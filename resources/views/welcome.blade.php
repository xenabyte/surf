...
<head>
        ...
        <meta content="Damilare Ogundedle" name="author" />
        <!-- App favicon -->
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                                ...
                                <div class="p-2">
                                    <form class="form-horizontal" action="{{ route('checkBalance') }}" method="POST">
                                        ...
                                        <div class="mt-4 text-center">
                                            <a class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#changePassword"><i class="mdi mdi-lock me-1"></i> Change Internet Access Password</a>
                                        </div>
                                    </form>
                                </div>
                                        ...
                                        <div class="p-2">
                                            <form class="form-horizontal" action="{{ route('updatePassword') }}" method="POST">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group auth-pass-inputgroup">
                                                        <input type="password" name="new_password" class="form-control" placeholder="Enter password" aria-label="Password" aria-describedby="password-addon">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group auth-pass-inputgroup">
                                                        <input type="password" name="confirm_password" class="form-control" placeholder="Enter password" aria-label="Password" aria-describedby="password-addon">
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                        ...
                        @if(!empty($user))
                        <!-- Data Balance Modal -->
                        <div class="modal fade" id="dataBalance" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <div class="p-2">
                                            <div class="user-thumb text-center mb-4">
                                                <img src="{{asset('assets/images/users/avatar-1.jpg')}}" class="rounded-circle img-thumbnail avatar-md" alt="thumbnail">
                                                <h5 class="font-size-15 mt-3">{{ $user->username .' '. $user->lastname }}</h5>
                                                <h3 class="mt-3">Data Balance: {{ $user->data_balance }}</h3> 
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
